...
export function normalizeDealData(rawData = {}) {
  const normalized = {
    ...
    staffName: asText(rawData.staffName || rawData.salesperson || rawData.salesConsultant || rawData.staff),
    staffPhone: asText(rawData.staffPhone || rawData.phone),
    staffPhotoUrl: asText(rawData.staffPhotoUrl),
    staffPhotoStatus: asText(rawData.staffPhotoStatus),
    ...
    totalTaxes: parseMoneyValue(rawData.totalTaxes),
