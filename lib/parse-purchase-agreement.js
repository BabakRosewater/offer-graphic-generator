...
export function parsePurchaseAgreement(raw = {}) {
  return {
    ...raw,
    staffName: cleanText(raw.staffName || raw.salesperson || raw.salesConsultant || raw.staff),
    ...
    totalTaxes: parseMoneyValue(raw.totalTaxes),
    ...
    rebate: parseMoneyValue(raw.rebate ?? raw.rebateAmount),
    rebateAmount: parseMoneyValue(raw.rebateAmount),
    paymentOptions: parsePaymentOptions(raw.paymentOptions),
    residualPercent: parseResidualPercent(raw.residualPercent ?? raw.residual ?? raw.selectedResidual),
